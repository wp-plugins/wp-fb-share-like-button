                            ...
                            <div class="right">
                                <center>
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div id="donateheretbl-comments-wvpd" class="togglediv">  
                                            <p><?php _e('If you want to purchase , please click on below image.', 'wp-fb-share-like-button'); ?></p>
                                            <a href="http://bit.ly/1Gwp4Vv" target="_blank"><img class="donate" src="<?php echo plugins_url('assets/blue_frog_banner.png', __FILE__); ?>" width="336" height="280" title="<?php _e('Donate Here', 'wp-fb-share-like-button'); ?>"></a>		
                                        </div> 
                                    </div>
                                </center>
                            </div>
